...
class NeuralNetwork(object):
    ...
    def forward_pass_train(self, X):
        ...
        #output activation function 𝑓(𝑥)=𝑥
    ...
    def backpropagation(self, final_outputs, hidden_outputs, X, y, delta_weights_i_h, delta_weights_h_o):
        ...
        # output_error_term = error*f'(x), f'(x) = 1.0
        ...
        # hidden_error_term = hidden_error * sigmoid(hidden_layer_input) * (1.0 - sigmoid(hidden_layer_input))
